...
@implementation TradeMenuViewController
...
- (void)viewDidLoad {
  ...
  self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"TradeMenuViewController_Image_1.png"]];
  ...
  textureView1ContentView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"TradeMenuViewController_Image_2.png"]];
  ...
  navigationBar1.topItem.title = @"Trade Menu";
  ...
  UIBarButtonItem *barButton1 = [[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"TradeMenuViewController_Image_3.png"] style:UIBarButtonItemStyleBordered target:nil action:nil] autorelease];
  ...
  imageView1.image = [UIImage imageNamed:@"TradeMenuViewController_Image_4.png"];
  ...
  [imageButton2 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_5.png"] forState:UIControlStateNormal];
  ...
  imageButton3.frame = CGRectMake(238, 166, 53, 54);
  ...
  [imageButton3 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_6.png"] forState:UIControlStateNormal];
  ...
  imageButton4.frame = CGRectMake(141, 166, 53, 54);
  ...
  [imageButton4 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_7.png"] forState:UIControlStateNormal];
  ...
  [imageButton5 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_8.png"] forState:UIControlStateNormal];
  ...
  imageButton6.frame = CGRectMake(37, 61, 53, 54);
  ...
  [imageButton6 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_9.png"] forState:UIControlStateNormal];
  ...
  imageButton7.frame = CGRectMake(141, 61, 53, 54);
  ...
  [imageButton7 setImage:[UIImage imageNamed:@"TradeMenuViewController_Image_10.png"] forState:UIControlStateNormal];
  ...
  UITabBarItem *tabBarItem1 = [[[UITabBarItem alloc] initWithTitle:@"Tradable" image:[UIImage imageNamed:@"TradeMenuViewController_Image_11.png"] tag:1] autorelease];
  tabBarItem1.badgeValue = @"2";
  ...
  UITabBarItem *tabBarItem2 = [[[UITabBarItem alloc] initWithTitle:@"Want" image:[UIImage imageNamed:@"TradeMenuViewController_Image_12.png"] tag:2] autorelease];
  ...
  UITabBarItem *tabBarItem3 = [[[UITabBarItem alloc] initWithTitle:@"For Sale" image:[UIImage imageNamed:@"TradeMenuViewController_Image_13.png"] tag:3] autorelease];
  ...
  UITabBarItem *tabBarItem4 = [[[UITabBarItem alloc] initWithTitle:@"Area Trades" image:[UIImage imageNamed:@"TradeMenuViewController_Image_14.png"] tag:4] autorelease];
